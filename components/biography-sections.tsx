      ...
      <section className="space-y-6 section-bg">
        ...
        <div className="space-y-6">
          {experience.map((exp, index) => {
            ...
            const isCurrent = exp.period.includes('現在') || exp.period.includes('Present') || exp.period.includes('至今');
                ...
                {exp.responsibilities && exp.responsibilities.length > 0 && (
                  <div className="mt-4 space-y-3">
                    <h5 className="text-sm font-medium text-foreground">
                      {language === 'zh' ? '主要職責' : 'Key Responsibilities'}
                    </h5>
                    <div className="space-y-2">
      ...
      <section className="space-y-6 section-bg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skills.map((skillGroup, index) => (
            <div key={index} className="space-y-3 p-4 bg-card rounded-lg card-hover border border-border/50">
      ...
      <section className="space-y-6 section-bg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {certifications.map((cert, index) => (
            <Card key={index} className="h-full card-hover border-2 border-border/50">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">{sectionTitles[language].issued}:</span>
                    <span>{cert.date}</span>
                  </div>
                  ...
                  {cert.expiryDate && (
                    <div className="flex items-center gap-2">
                      <Calendar className="h-4 w-4 text-muted-foreground" />
                      <span className="text-muted-foreground">{sectionTitles[language].expires}:</span>
                  ...
                  {!cert.expiryDate && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-green-600 font-medium">{sectionTitles[language].noExpiry}</span>
                    </div>
                  )}
                  
                  <div className="flex items-center gap-2">
                    <span className="text-muted-foreground">{sectionTitles[language].credentialId}:</span>
